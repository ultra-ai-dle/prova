...
export const TOUR_STEPS: TourStep[] = [
  {
    ...
    body: "AI가 알고리즘의 실행 흐름을 시각화해 주는 디버거입니다. 핵심 기능을 안내해 드릴게요. 이 투어는 약 1분 정도 걸립니다.",
  },
  {
    targetSelector: '[data-tour="editor"]',
    placement: "right",
    title: "코드 에디터",
    body: "여기에 알고리즘 코드를 작성하세요. BFS, DFS, DP 등 다양한 알고리즘을 지원합니다. 기본 예시 코드가 미리 채워져 있어요.",
  },
  {
    targetSelector: '[data-tour="language"]',
    placement: "bottom-left",
    title: "언어 선택",
    body: "Python과 JavaScript를 지원합니다. 코드 패턴을 자동으로 감지하기도 해요.",
  },
  {
    targetSelector: '[data-tour="input"]',
    placement: "left",
    title: "입력 & 실행",
    body: "stdin 입력값을 작성하고 디버깅 시작 버튼을 클릭하세요. AI가 코드를 분석하고 시각화 전략을 결정합니다.",
  },
  {
    targetSelector: '[data-tour="visualization"]',
    placement: "left",
    title: "시각화 패널",
    body: "AI가 선택한 전략(격자, 그래프, 선형 등)에 맞춰 알고리즘 동작을 애니메이션으로 보여줍니다.",
  },
  {
  ...
  },
  {
    ...
    placement: "left",
    title: "변수 모니터",
    body: "각 단계에서 변수 값이 어떻게 변하는지 실시간으로 추적합니다. 변경된 변수는 노란색으로 강조됩니다.",
  },
];
