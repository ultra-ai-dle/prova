...
<sup><strong>AI</strong> - <code>analyze</code>로 알고리즘과 변수를 분류하고, <code>explain</code>으로 스텝별 해설을 SSE로 붙입니다.</sup><br />
...
<blockquote>
  브라우저에서 코드를 실행하고, AI가 흐름을 시각화하고 해설하는 <br /><strong>Frogger</strong>를 만듭니다. <br />
</blockquote>
